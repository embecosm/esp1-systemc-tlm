...
main()
{
  /* Write the byte 0xa5 to location 0x9000 */

  __asm__ __volatile__ ( "\tl.movhi\tr13,0x9000"   );
  __asm__ __volatile__ ( "\tl.ori\tr13,r13,0x0"    );
  __asm__ __volatile__ ( "\tl.movhi\tr14,0x0000"   );
  __asm__ __volatile__ ( "\tl.ori\tr14,r14,0x00a5" );
  __asm__ __volatile__ ( "\tl.sb\t0x(r13),r14"     );
